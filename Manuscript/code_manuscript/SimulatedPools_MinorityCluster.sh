...
# Simulated pools were produced using the synth_pool.py script produced by the developers of Vireo. 24 samples were multiplexed per pool with with one line showing varying degrees of underpresentation
# Below is an example script for producing a simulated pool from  24 lines, 23 lines contained ~1000 cells and 1 line contained 100 cells (10% representation)
...
SYNTHDIR=/home/fiorini9/scratch/mjff/emsemblux_seq_feature_eval/minority_cluster/$POOL 
...
DATADIR=/home/fiorini9/scratch/mjff/emsemblux_seq_feature_eval/minority_cluster 
...
cat $DATADIR/$POOL/$S24.tsv | awk 'NR >= 0  && NR <= 100' > BC24.tsv # minority cluster
