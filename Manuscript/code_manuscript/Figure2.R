...
# NOTES #
#########
# This code was used to produce Figure 2 of the ensemblex manuscript
...
## Figure 2 function
# PWE = ensemblex probabilistic-weighted ensemble output
# GBE = ensemblex graph-based doubet detection output
# EID = ensemblex ebsemble-independent doublet detection output
...
figure_2 <- function(PWE, GBD, EID, run_code, size){
    ### evaluate PWE
        ...
        PWE_singlet$ensemblex_eval <- "bad"
        PWE_singlet$ensemblex_eval[PWE_singlet$assignment_R_consensus == PWE_singlet$truth ] <- "good"
        test <- data.frame(table(PWE_singlet$ensemblex_eval))
        ...
        PWE_doublet$ensemblex_eval <- "bad"
        PWE_doublet$ensemblex_eval[PWE_doublet$assignment_R_consensus == PWE_doublet$truth ] <- "good"
        test <- data.frame(table(PWE_doublet$ensemblex_eval))
        prop <- test$Freq[test$Var1 == "good"]
    ...
    ### evaluate GBD
        ...
        GBD_singlet$ensemblex_eval <- "bad"
        GBD_singlet$ensemblex_eval[GBD_singlet$assignment_R_consensus == GBD_singlet$truth ] <- "good"
        test <- data.frame(table(GBD_singlet$ensemblex_eval))
        prop <- test$Freq[test$Var1 == "good"]
        ...
        GBD_doublet$ensemblex_eval <- "bad"
        GBD_doublet$ensemblex_eval[GBD_doublet$assignment_R_consensus == GBD_doublet$truth ] <- "good"
        test <- data.frame(table(GBD_doublet$ensemblex_eval))
        prop <- test$Freq[test$Var1 == "good"]
    ...
    ### evaluate EID
        ...
        EID_singlet$ensemblex_eval <- "bad"
        EID_singlet$ensemblex_eval[EID_singlet$assignment_R_consensus == EID_singlet$truth ] <- "good"
        test <- data.frame(table(EID_singlet$ensemblex_eval))
        prop <- test$Freq[test$Var1 == "good"]
        ...
        EID_doublet$ensemblex_eval <- "bad"
        EID_doublet$ensemblex_eval[EID_doublet$assignment_R_consensus == EID_doublet$truth ] <- "good"
        test <- data.frame(table(EID_doublet$ensemblex_eval))
        prop <- test$Freq[test$Var1 == "good"]
