...
echo " " >> $TEMPFILERUN
echo " echo \" End of Vartrix step \" " >> $TEMPFILERUN
echo " " >> $TEMPFILERUN

echo "#----------------------------------------------------------------#" >> $TEMPFILERUN
echo " echo \"Start of Clustering cells by genotype \" "  >> $TEMPFILERUN
...
echo " " >> $TEMPFILERUN
echo " echo \"End of Clustering cells by genotype\" " >> $TEMPFILERUN

echo " " >> $TEMPFILERUN
echo "#----------------------------------------------------------------#" >> $TEMPFILERUN
echo " echo \"Start of Calling doublets step\" " >> $TEMPFILERUN
...
echo "#----------------------------------------------------------------#" >> $TEMPFILERUN
echo " echo \" Start Genotype and ambient RNA coinference step\" " >> $TEMPFILERUN
