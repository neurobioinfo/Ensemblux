...
#----------------------------------------------------------------#
echo "-------------------------------------------"
echo "* step Demuxalot No-GT submitted at `date +%FT%H.%M.%S`"
echo "-------------------------------------------"
